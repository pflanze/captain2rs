...
- Install [maturin](https://github.com/PyO3/maturin): see [Installation - Maturin User Guide](https://www.maturin.rs/installation); I have a fork with somewhat verified dependencies that I use [here](https://github.com/pflanze/maturin).
